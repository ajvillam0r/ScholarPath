    ...
    <div class="min-h-screen flex items-center justify-center">
        <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
            ...
            <div class="flex justify-center mb-6">
                <img src="https://storage.googleapis.com/a1aa/image/u16ksT3brB4YHdEfVsvDdB7Nw1QS9BeAlDJsfm2M0VD0iwznA.jpg" alt="ScholarPath Logo" class="h-16">
            </div>
            ...
            @if (session('success'))
                ...
                <div class="text-center mb-4">
                    <a href="{{ route('staff.login') }}" class="w-full bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        Go to Login
                    </a>
                </div>
            @else
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" id="staff_id" name="staff_id" maxlength="8" placeholder="Enter your Staff ID Number" type="number" required oninput="validateStaffID()" />
            ...
            <div class="text-center mt-4">
                <a href="{{ route('staff.login') }}" class="w-full bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500">
